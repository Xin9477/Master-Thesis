...
if __name__ == '__main__':
    ...
    # 加载微调后的模型和 tokenizer
    model_path = '/tmp/hongloumeng/hf_compatible_fenleiFTed_4'
    tokenizer_path = '/tmp/hongloumeng/hf_compatible_fenleiFTed_4'
    ...
    # 测试集范围
    y_test_range = file_list_y[48:64]  # Y-dataset 第49到64章
    n_test_range = file_list_n[24:32]  # N-dataset 第105到112章
    ...
    # 输出文件路径
    performance_file = '/tmp/hongloumeng/trained_bert_performance4.txt'
    percentage_file = '/tmp/hongloumeng/trained_bert_percentage4.txt'

    with open(performance_file, 'w') as perf_f, open(percentage_file, 'w') as perc_f:
        datasets = [
            (y_test_range, folder_path_y, 49),  # Y-dataset 第49到64章
            (n_test_range, folder_path_n, 105)  # N-dataset 第105到112章
        ]
