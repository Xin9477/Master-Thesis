...
if __name__ == '__main__':
    ...
    # 加载微调后的模型和 tokenizer
    model_path = '/tmp/hongloumeng/hf_compatible_fenleiFTed_3'
    tokenizer_path = '/tmp/hongloumeng/hf_compatible_fenleiFTed_3'
    ...
    # 测试集范围
    y_test_range = file_list_y[32:48]  # Y-dataset 第33到48章
    n_test_range = file_list_n[16:24]  # N-dataset 第97到104章
    ...
    # 输出文件路径
    performance_file = '/tmp/hongloumeng/trained_bert_performance3.txt'
    percentage_file = '/tmp/hongloumeng/trained_bert_percentage3.txt'

    with open(performance_file, 'w') as perf_f, open(percentage_file, 'w') as perc_f:
        datasets = [
            (y_test_range, folder_path_y, 33),  # Y-dataset 第33到48章
            (n_test_range, folder_path_n, 97)   # N-dataset 第97到104章
        ]
